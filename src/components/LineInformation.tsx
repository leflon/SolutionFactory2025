...
async function fetchLineInfo(lineId: string) {
    ...
    if (!res.ok) throw new Error("Erreur lors de la récupération des informations de la ligne");
    ...
    useEffect(() => {
        ...
        async function loadLineInfo() {
            try {
                ...
                console.error("Erreur lors de la récupération des informations de la ligne :", error);
            }
        }
            ...
            {showInfo && (
                ...
                >
                    <div className="flex items-center justify-center mb-4 gap-2">
                        <h2 className="text-lg font-bold dark:text-white">Informations -</h2>
                        <Image
